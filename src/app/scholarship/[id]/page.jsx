        ...
        <ul className="my-7">
          <li className="mb-1">
            <span className="flex mr-4 text-lg text-[#4b5563] rounded">
              ...
              <p className="text-lg mb-[-2px]">Location: {scholarship.location}</p>
            </span>
          </li>
          <li className="mb-1">
            <span className="flex mr-4 text-lg text-[#4b5563] rounded">
          ...
          <li className="mb-1">
            <span className="flex mr-4 text-lg text-[#4b5563] rounded mt-[-10px]">
              ...
              <p className="text-lg py-2 ml-[1px] mt-[2px]">School name: {scholarship.schoolName}</p>
            </span>
          </li>
        </ul>
        <div className="">
          <Button onClick={showModal} style={{ backgroundColor: '#f95c39', color: 'white', fontSize: '20px', width:'200px', height:'40px'}}>APPLY</Button>
          <Modal
