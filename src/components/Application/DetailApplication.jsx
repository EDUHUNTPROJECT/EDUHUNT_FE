            ...
            const fetchApplicationDetail = async () => {
                ...
                try {
                    ...
                    if (appDetail && appDetail.scholarshipID) {
                        const schDetail = await getDetailScholarShip(appDetail.scholarshipID);
        ...
        <div style={{ padding: '20px' }}>
            <Card bordered={false}>
                ...
                <Descriptions layout="vertical" bordered>
                    <Descriptions.Item label="Budget">{scholarship.budget ? formatBudget(scholarship.budget) : "N/A"}</Descriptions.Item>
