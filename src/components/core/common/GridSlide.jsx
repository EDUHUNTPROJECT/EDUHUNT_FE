        ...
        <div className="w-full h-[55vh]" style={{background: '#FAFAFA'}}>
            ...
            <div className='grid place-items-center h-[78%]'>
                <div className='w-[93%] h-[100%] flex justify-center items-center'>
                    ...
                    <div className='absolute -translate-x-[-100%] translate-y-[-50%] left-3 text-2xl rounded p-2 bg-black/20 text-black cursor-pointer' style={{color: 'black'}}>
                        <BsChevronCompactLeft onClick={lastSlide} size={50} />
                    </div>

                    <div className='absolute -translate-x-[100%] translate-y-[-50%] right-3 text-2xl rounded p-2 bg-black/20 text-black cursor-pointer' style={{color: 'black'}}>
